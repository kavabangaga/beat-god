...
public class BeatGod {
    ...
    int[] instruments = {35, 42, 46, 38, 49, 39, 50, 60, 70, 72, 64, 56, 58, 47, 67, 63};//The # of instruments

    public static void main(String[] args) {                              //MAIN
        BeatGod beat = new BeatGod();
        beat.buildGUI();
    }

    public void buildGUI() {
        frame = new JFrame("BeatGod Machine");
